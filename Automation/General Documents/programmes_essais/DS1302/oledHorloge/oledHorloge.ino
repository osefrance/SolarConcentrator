...
void LED_PrintValueI(unsigned char x, unsigned char y, int data)
{
 ...
 void loop()
 {
    t = rtc.getTime();
   /*
    LED_P8x16Str(12,1,"Brought to you");
    LED_P8x16Str(60,3,"BY");
    LED_P8x16Str(12,5,"Libre HardWare");
    */
    itoa(t.hour,buffer,10);
    LED_P8x16Str(12,1,buffer);
    LED_P8x16Str(27,1,":");
    
    itoa(t.min,buffer,10);
    LED_P8x16Str(35,1,buffer);
    LED_P8x16Str(50,1,":");
    
    itoa(t.sec,buffer,10);
    LED_P8x16Str(58,1,buffer);
    
    itoa(t.date,buffer,10);
    LED_P8x16Str(12,3,buffer);
    LED_P8x16Str(27,3,"/");
    
    itoa(t.mon,buffer,10);
    LED_P8x16Str(35,3,buffer);
    LED_P8x16Str(50,3,"/");
    
    itoa(t.year,buffer,10);
    LED_P8x16Str(58,3,buffer);
