  ...
  //STEPPER
  int stepPin[2] = {31, 33, 35}; // pin 31 motor 1; 33 motor 2; 35 motor 3 (yellow wires)
  int dirPin[2] = {31, 33, 35}; // pin 33 motor 1; 33 motor 2; 35 motor 3 (white wires)
  int enablePin[2] = {31, 33, 35}; //pin 35 motor 1; 33 motor 2; 35 motor 3 (green wire)
  ...
  int FDCM0 = 24;// Contact switch for Miror 0
  int FDCM1 = 26;// Contact switch for Miror 1
  int FDCM2 = 28;// Contact switch for Miror 2
