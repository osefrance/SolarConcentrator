...
const int mirrorsQ = 11; // how many mirrors should be controlled. if through the MCP23017 they should be connected incrementally starting from port A0 of MCP23017
int mirrorsQbin = ; // mirrorsQconversion to consecutive bits rappresenting each single motors
...
const int mirrorSelBinA []= {B00000001,B00000010,B00000100, B00001000, B00010000,B00100000,B01000000,B10000000} ;
const int mirrorSelBinB []= {B00000001,B00000010,B00000100, B00001000, B00010000,B00100000,B01000000,B10000000} ;
const int mirrorSelBinC []= {B00000001,B00000010,B00000100, B00001000, B00010000,B00100000,B01000000,B10000000} ;

int mirrorSel = 0; // index for the mirror selector. new usage index to the matrixes mirrorSelBinX . Old usage : when using the MCP23017 it will be set to 255 to step on all motors at the same time (set to 0 if used as index for stepPin[] matrix, set to 1 if used as pointer for the MCP23017 port extender
